...
class InputPasswordScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InputPasswordScreen> createState() =>
      _InputPasswordScreenState();
}
...
class _InputPasswordScreenState extends ConsumerState<InputPasswordScreen> {
  ...
  void _handleNext() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const ChooseImageScreen()),
    );
  }
  ...
  void _loginHandle() async {
    ...
    controller
        .loginWithPassword(emailOrPhone ?? '', passwordController.text)
        .then(
      (value) async {
        if (value == true) {
