...
import 'package:seetle/src/screen/auth/inputNickname.dart';
...
class _BirthdayPickerScreenState extends State<BirthdayPickerScreen> {
  ...
  void _handleNext() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const InputNicknameScreen()),
    );
  }
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      selectedDate != null ? _formatDate(selectedDate) : "YYYY  MM  DD",
