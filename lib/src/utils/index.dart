...
/// New function for consistent circular shapes based on the smallest screen dimension.
double vMin(BuildContext context, double percentage) {
  double minDimension = MediaQuery.of(context).size.shortestSide;
  return minDimension / 100 * percentage;
}